...
<audio controls className="w-full my-4">
    <source src="/documents/posts/dogdays/DogDays.mp3" type="audio/mpeg" />
    Your browser does not support the audio element.
</audio><br />
You can also take a look at the sheet music <a href="/documents/posts/dogdays/DogDaysSheetMusic.pdf" className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-800">here</a>.
